...
background2 = pygame.image.load(os.path.join(loc, 'images/background2.jpeg')).convert()
background2 = pygame.transform.scale(background2, (WIDTH, HEIGHT))
background2_rect = background2.get_rect()
background3 = pygame.image.load(os.path.join(loc, 'images/background3.jpg')).convert()
background3 = pygame.transform.scale(background3, (WIDTH, HEIGHT))
background3_rect = background3.get_rect()
op1 = pygame.image.load(os.path.join(loc, 'images/T-PI.png')).convert()
op12 = pygame.transform.scale(op1, (380,180))
op12_rect = op12.get_rect()
op12_rect.center = (200, 150)
op5 = pygame.image.load(os.path.join(loc, 'images/rlc.jpg')).convert()
op5 = pygame.transform.scale(op5, (380,180))
op5_rect = op5.get_rect()
op5_rect.center = (200, 600)
yparam = pygame.image.load(os.path.join(loc, 'images/Y-parameter.jpg')).convert()
yparam_rect = yparam.get_rect()
zparam = pygame.image.load(os.path.join(loc, 'images/Z-parameter.jpg')).convert()
